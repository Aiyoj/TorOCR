...
class Logger(object):
    ...
    def __init__(self, configs):
        ...
        self.log_dir = self.cfg.get("log_dir", "workspace")
        self.verbose = self.cfg.get("verbose", False)
        self.level = self.cfg.get("level", "info")
        self.log_interval = self.cfg.get("log_interval", 100)
        self.name = self.cfg.get("name", "model")
